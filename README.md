...
- Сувора перевірка частин домену, підтримка кількох доменів у строці (наприклад, nasepravda.cz,example.com).
- Збережено повну підтримку Unicode для всіх мов (кирилиця, китайська, арабська тощо) — готові до будь-яких "екзотичних" доменів! 😎
